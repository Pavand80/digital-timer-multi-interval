...
<p align="center">
  <img src="docs/block%20diagram.png" alt="Block Diagram" width="900">
</p>

## 🔄 Working Flow

User selects interval (5s / 10s / 15s / 20s)

MUX assigns corresponding countdown value

Clock divider generates 1Hz pulse

Counter decrements every second

When count reaches zero → output is triggered

### Flow Chart

<p align="center">
  <img src="docs/flow%20chart.png" alt="Flow Chart" width="700">
</p>
